<%@ Page Title="Club President List" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ViewClubPresidents.aspx.cs" Inherits="Admin_ViewClubPresidents" %>
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            ...
                            <span style="float: right;"><a class="btn btn-success btn-sm" href="ClubPresidents.aspx"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;Add President</a></span>
                        </div>

                        <div class="box-content">

                            <div style="padding-bottom:5px;">
                                <asp:DropDownList ID="ddlDistNo" Width="200" runat="server" CssClass="form-control" AutoPostBack="true" AppendDataBoundItems="true">
                                    ...
                                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" DataSourceID="DSPresidents"
                                        ...
                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Top"></ItemStyle>
                                            ...
                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top"></ItemStyle>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False">
                                                    <ItemTemplate>
                                                        <a href='ClubPresidents.aspx?id=<%# Eval("id") %>'>
