...
public partial class Admin_ClubPresidents : System.Web.UI.Page
{   
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["user"] != null)
        {
            ...
            {
                BindDistrictNo();
                lblHeading.Text = "Add Club President";
    ...
    private void GetPresident(int id)
    {
        ...
        if (dt.Rows.Count > 0)
        { 
            lblHeading.Text = "Edit President's Details";
    ...
    private void AddPresident()
    {
        try
        {
            ...
            {             
                ...
                Clear();
                string jv = "<script>alert('President Has Been Added Successfully');</script>";
    ...
    private void UpdatePresident(int id)
    {
        try
        {
            ...
            {               
                Clear();
                showmsg("President Has Been Updated Successfully", "ViewClubPresidents.aspx");
